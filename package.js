...
var packageName = 'webix:skin-compact';  // https://atmospherejs.com/webix/skin-compact
...
Package.describe({
  name: packageName,
  summary: 'Compact skin for Webix UI',
  version: version,
  git: 'https://github.com/MeteorPackaging/webix-skin-compact',
...
Package.onUse(function (api) {
  ...
  api.addFiles(['webix/codebase/skins/debug/compact.css'], 'client');
